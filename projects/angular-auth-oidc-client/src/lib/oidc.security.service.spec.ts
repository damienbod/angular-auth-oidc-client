...
describe('OidcSecurityService', () => {
  ...
  describe('preloadAuthWellKnownDocument', () => {
    it(
      'calls authWellKnownService.queryAndStoreAuthWellKnownEndPoints with config',
      waitForAsync(() => {
  ...
  describe('getUserData', () => {
    it(
      'calls configurationProvider.getOpenIDConfiguration with config',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
  ...
  describe('checkAuth', () => {
    ...
    it(
      'calls checkAuthService.checkAuth() with url if one is passed',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfigurations').and.returnValue(of({ allConfigs: [config], currentConfig: config }));
  ...
  describe('checkAuthMultiple', () => {
    ...
    it(
      'calls checkAuthService.checkAuthMultiple() with url if one is passed',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfigurations').and.returnValue(of({ allConfigs: [config], currentConfig: config }));
  ...
  describe('isAuthenticated()', () => {
    it(
      'calls authStateService.isAuthenticated with passed configId when configId is passed',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
  ...
  describe('getPayloadFromIdToken', () => {
    it(
      'calls `authStateService.getIdToken` method, encode = false',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
    ...
    it(
      'calls `authStateService.getIdToken` method, encode = true',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
        spyOn(authStateService, 'getIdToken').and.returnValue('some-token');
  ...
  describe('authorize', () => {
    ...
    it(
      'calls login service login with authoptions',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
        const spy = spyOn(loginService, 'login');
  ...
  describe('revokeAccessToken', () => {
    it(
      'calls logoffRevocationService.revokeAccessToken',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
    ...
    it(
      'calls logoffRevocationService.revokeAccessToken with accesstoken',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
        const spy = spyOn(logoffRevocationService, 'revokeAccessToken').and.returnValue(of(null));
  ...
  describe('revokeRefreshToken', () => {
    it(
      'calls logoffRevocationService.revokeRefreshToken',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
    ...
    it(
      'calls logoffRevocationService.revokeRefreshToken with refresh token',
      waitForAsync(() => {
        const config = { configId: 'configId1' };
        spyOn(configurationService, 'getOpenIDConfiguration').and.returnValue(of(config));
        const spy = spyOn(logoffRevocationService, 'revokeRefreshToken').and.returnValue(of(null));
