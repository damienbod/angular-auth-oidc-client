...
Renaming the stsServer to authority. The authority issues tokens. Sometimes this is called issuer, secure token service, auth server, identity provider. The authority is sometimes known as the issuer.
